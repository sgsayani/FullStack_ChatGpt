...
const Sidebar = () => {
  ...
  return (
    <div className='flex flex-col h-screen min-w-72 p-5 dark:ng-gradient-to-b from-[#242124]/30 to-[#000000]/30 border-r border-[#80609F]/30 backdrop-blur-3xl transition-all duration-500maax-md:absolute left-0 z-1'>
      {/* logo */}
      ...
      <div className='flex items-center gap-2 p-3 mt-4 border border-gray-400 dark:border-white/20 rounded-md'>
        ...
        <input onChange={(E) => setSearch(e.target.value)} value={search} type="text" placeholder='Search Converstations' className='text-xs placeholder:text-gray-400 outline-none' />
      </div>
